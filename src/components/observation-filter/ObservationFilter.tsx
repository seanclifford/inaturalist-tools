...
export default function ObservationFilter({opened, close, pageQueryString, runQuery}: ObservationFilterProps) {
    return (
        <Modal opened={opened} onClose={close} title="Observation Filter" centered size="lg">
        <Stack gap="xs">
